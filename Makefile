...
objects = Block.o BlockBuffer.o FileManager.o Header.o HeaderBuffer.o Index.o IndexBuffer.o IndexRecord.o \
	 IndexRecordBuffer.o InputFileHeader.o rbuffer1.o Record.o SeqSetExceptions.o SequencedSet.o main.o
pobjects = $(addprefix $(BUILDDIR),$(objects))

$(BUILDDIR)SeqSetDriver: $(pobjects)
	 $(CXX) -o $(BUILDDIR)SeqSetDriver $(pobjects)
...
$(BUILDDIR)main.o: SequencedSet.h Record.h Block.h
	 $(CXX) -c testDriver.cpp -o $(BUILDDIR)main.o

.PHONY : clean
clean :
	 rm $(BUILDDIR)SeqSetDriver $(pobjects)